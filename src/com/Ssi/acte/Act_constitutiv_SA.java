			     ...
			     String heightString1 = numarAsoc.getText().toString();
			      heightInt = Integer.parseInt(heightString1);
			    	...
			    	if(fasoc1.isChecked()){
			    		...
			    		asoc2.add(new Chunk("               S.C. "+j11.getText()+", persoană juridică "+naties+", cu sediul social în "+j12.getText()+", " +
			    				"înregistrată la "+j1.getText()+", având următoarele date de identificare  "+j21.getText()+", reprezentată de ",paraFontfor ));
			    		...
			    		doc.add(asoc2) ;
			    			...
			    			asoc2.add(new Chunk(dna+" "+sc_nume.getText()+", cetăţean "+strain+", CNP "+sc_cnp.getText()+" identificat cu "+ident+", seria "+sc_seria.getText()+", nr. "+sc_nr.getText()+", eliberat de "+sc_elibde.getText()+",  " +
			    					"la data de "+sc_data.getText()+", domiciliat în "+sc_dom.getText()+", str. "+sc_str.getText()+", nr. "+sc_nr2.getText()+", bl "+sc_bl.getText()+", sc. "+sc_sc.getText()+", et. "+sc_et.getText()+", ap "+sc_ap.getText()+", " +
			    							"in calitate de împuternicit prin "+sc_impu.getText()+", nr. "+sc_nr3.getText()+", din data "+sc_data2.getText()+", ",paraFontfor ));
			    			doc.add(asoc2) ;
			    		}
								 ...
								 doc.add(new Paragraph( (i+1)+".    "+num[i].getText()+", cetăţean român, domiciliat în " +
									 ...
									 doc.add(new Paragraph( (i+1)+".    "+num[i].getText()+", cetăţean român, domiciliat în " +
										...
										doc.add(new Paragraph((i+1)+".    S.C. "+sc[i].getText()+", persoană juridică "+nat+", cu" +
								 		...
								 		"bl. "+blcc[i].getText()+", sc. "+sccc[i].getText()+", et. "+etcc[i].getText()+" ap. "+apcc[i].getText()+",  "+jj+"  "+jscc1[i].getText()+", înregistrată la " +
							  ...
							  if(pf.isChecked()){
								...
								RadioGroup radioGroup5 = (RadioGroup) findViewById(R.id.radioGroupc);
								 ...
								 s4.add(new Chunk("S.C. "+cj1.getText()+", persoană juridică cu sediul social  în "+cj.getText()+" , str. "+cj2.getText()+" nr. "+cj3.getText()+" , " +
								 		"bl. "+cj4.getText()+"  , sc. "+cj5.getText()+" , et. "+cj6.getText()+" ap. "+cj7.getText()+" , "+jj+"  "+cs.getText()+", înregistrată la " +
