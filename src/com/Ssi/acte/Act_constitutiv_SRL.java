			...
			try {
				...
				doc.open();
				 ...
				 Paragraph p1 = new Paragraph("ACT  CONSTITUTIV AL  \n" +
				 		"SOCIETĂŢII "+txtData.getText()+" S.R.L.\n",paraFont);
				...
				doc.add(Chunk.NEWLINE) ;
				  ...
				  Paragraph p9 = new Paragraph("             Denumirea societăţii este: "+denumire.getText() +" S.R.L., conform dovezii privind disponibilitatea " +
				...
				doc.add(new Paragraph("Durata de funcţionare a societăţii este nedeterminată.",paraFont2));
					...
					doc.add(new Paragraph("Durata de funcţionare a societăţii este pe o perioadă de "+f61.getText() +". ani, de la data de "+f62.getText()+" până la data de" +
							f63.getText()+" și poate fi prelungită în condițiile prevăzute de lege.",paraFont2));
				}
				...
				if(nr>0){
				 ...
				 doc.add(new Paragraph("	        Hotărârea adunării asociaţilor, adoptată în condiţiile alin. (2), se depune în termen de 15 zile la oficiul registrului comerţului, spre a fi menţionată în registru şi publicată în Monitorul Oficial al României, Partea a IV-a.",paraFont2));
				 
				 doc.add(new Paragraph("	        Transmiterea părţilor sociale se înregistrează în Registrul Comerţului şi în registrul de asociaţi al societăţii.",paraFont2));
				 
				 doc.add(new Paragraph("	        Actul de transmitere a părţilor sociale şi actul constitutiv actualizat cu datele de identificare a noilor asociaţi vor fi depuse la oficiul registrului comerţului, fiind supuse înregistrării în registrul comerţului potrivit dispoziţiilor art. 204 alin. (4).din Legea nr. 31/1990 privind societățile comerciale, republicată, cu modificările și completările ulterioare.",paraFont2));
                ...
                doc.add(Chunk.NEWLINE) ;
				 ...
				 doc.add(p32) ;
	                ...
	                doc.add(Chunk.NEWLINE) ;
					 ...
					 doc.add(new Paragraph("având puteri depline de reprezentare şi administrare a societăţii, pe o perioadă "+nel+"  . (În cazul în care sunt numiţi mai mulţi administratori, se vor menţiona puterile ce li s-au conferit şi dacă ei urmează să le exercite împreună sau separat).",paraFont2));
					 doc.add(new Paragraph("Potrivit prevederilor art. 2015 din Legea nr. 287/2009 privind Codul civil, republicată, dacă părțile nu au prevăzut un termen, contractul de mandat încetează în 3 ani de la încheierea lui.",paraFont2));
					 ...
					 doc.add(new Paragraph("Un asociat sau un număr de asociaţi ce reprezintă cel puţin o pătrime din capitalul social, vor putea cere convocarea adunării generale arătând scopul acestei convocări.",paraFont2));
					 ...
					 doc.add(Chunk.NEWLINE) ;
		                doc.add(Chunk.NEWLINE) ;
						 ...
						 t2.add(new Chunk("Exerciţiul economico - financiar începe la 1 ianuarie şi se termină la 31 decembrie ale fiecărui an. Primul exerciţiu va începe la data constituirii societăţii.",paraFont2));			
						 doc.add(t2) ;
						 ...
						 t4.add(new Chunk("Situaţiile financiare vor fi întocmite după normele prevăzute de lege.",paraFont2));			
						 doc.add(t4) ;
						 ...
						 doc.add(new Paragraph("	        2. Dividendele se plătesc asociaţilor proporţional cu cota de participare la capitalul social vărsat, dacă, " +
						 		...
						 		"încheiat. În caz contrar, societatea comercială datorează, după acest termen, dobândă penalizatoare calculată conform art. 3 din " +
						 		"Ordonanţa Guvernului nr. 13/2011 privind dobânda legală remuneratorie şi penalizatoare pentru obligaţii băneşti, precum şi pentru " +
						 		"reglementarea unor măsuri financiar-fiscale în domeniul bancar, aprobată prin Legea nr. 43/2012, dacă prin hotărârea adunării generale " +
						 		"a acţionarilor care a aprobat situaţia financiară aferentă exerciţiului financiar încheiat nu s-a stabilit o dobândă mai mare.",paraFont2));
                             ...
                             RadioGroup radioGroup4 = (RadioGroup) findViewById(R.id.radioGroupc3);
							  ...
							  if(pf.isChecked()){
								 ...
								 s4.add(new Chunk(", având CUI: "+cj12.getText()+", reprezentată de "+Dj+"   " +
								 		cj14.getText()+", până la data de "+cj15.getText()+", expert contabil autorizat.",paraFont2));			
